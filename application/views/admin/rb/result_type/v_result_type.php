                  ...
                  <tr>
                    ...
                    <td>
                      <?php if ($result_type[$a]["status_aktif_result_type"] == 0) : ?>
                        <a href="<?php echo base_url(); ?>admin/rb-function/result_type/activate/<?php echo $result_type[$a]["id_pk_result_type"]; ?>" class="btn btn-light btn-sm col-lg-12">ACTIVATE</a>
                      <?php else : ?>
                        <a href="<?php echo base_url(); ?>admin/rb-function/result_type/deactive/<?php echo $result_type[$a]["id_pk_result_type"]; ?>" class="btn btn-danger btn-sm col-lg-12">DEACTIVE</a>
                      <?php endif; ?>
                      <a href="<?php echo base_url(); ?>admin/rb-function/result_type/delete/<?php echo $result_type[$a]["id_pk_result_type"]; ?>" class="btn btn-dark btn-sm col-lg-12">DELETE</a>
