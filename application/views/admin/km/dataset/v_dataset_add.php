            ...
            <div class="col-xl-12">
              ...
              <div class="example-wrap">
                <div class="nav-tabs-vertical" data-plugin="tabs">
                  ...
                  <form action="<?php echo base_url(); ?>admin/km-function/dataset/insert" method="post">
                    <div class="tab-content">
                      <div class="tab-pane active" id="primaryData" role="tabpanel">
                        <div class="form-group">
                          <h5>Dataset Name</h5>
                          <input type="text" class="form-control" name="dataset_name" required placeholder="What is this dataset user-friendly name?">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="tab-pane" id="buildQuery" role="tabpanel">
                        <div class="form-group">
                          ...
                          <input type = "text" class = "form-control" list = "intent_list" name = "intent">
