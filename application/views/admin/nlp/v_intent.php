    ...
    <div class="panel">
      <div class="panel-body container-fluid">
        <div class="page-header">
          <h1 class="page-title">MASTER INTENT</h1>
          <br />
          <ol class="breadcrumb breadcrumb-arrow">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">Database Intent</li>
          </ol>
        </div>
        <br />
        ...
        <div class="page-body">
          <div class="col-lg-12">
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahIntent">+ ADD INTENT</button>
            <br /><br />
              ...
              <tbody>
                <?php for ($a = 0; $a < count($intent); $a++) : ?>
                  <tr>
                    ...
                    <td style="overflow-wrap:break-word"><?php echo $intent[$a]["id"]; ?></td>
                    <td style="overflow-wrap:break-word"><?php echo $intent[$a]["name"]; ?></td>
                    <td style="overflow-wrap:break-word">
                      <a href="<?php echo base_url(); ?>admin/nlp-function/intent/delete/<?php echo $intent[$a]["name"]; ?>" class="btn btn-dark btn-sm col-lg-12">DELETE</a>
                    </td>
                  </tr>
                <?php endfor; ?>
              </tbody>
        ...
        <div class="modal fade" id="tambahIntent">
          <div class="modal-dialog modal-center">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?php echo base_url(); ?>admin/nlp-function/intent/insert" method="POST">
                  <div class="form-group">
                    <h5>Intent Name</h5>
                    <input required type="text" class="form-control" name="intent_name">
                  </div>
