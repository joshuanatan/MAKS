    ...
    <div class="panel">
      <div class="panel-body container-fluid">
        <div class="page-header">
          <h1 class="page-title">MASTER ENTITY</h1>
          <br />
          <ol class="breadcrumb breadcrumb-arrow">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">Database Entity</li>
          </ol>
        </div>
        <br />
              ...
              <tbody>
                <?php for ($a = 0; $a < count($entity); $a++) : ?>
                  <tr>
                    ...
                    <td style="overflow-wrap:break-word"><?php echo $entity[$a]["id"]; ?></td>
                    <td style="overflow-wrap:break-word"><?php echo $entity[$a]["name"]; ?></td>
                    <td style="overflow-wrap:break-word">
                      <a href="<?php echo base_url(); ?>admin/nlp-function/entity/delete/<?php echo $entity[$a]["name"]; ?>" class="btn btn-dark btn-sm col-lg-12">DELETE</a>
                    </td>
                  </tr>
                <?php endfor; ?>
              </tbody>
          ...
          <div class="modal-dialog modal-center">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?php echo base_url(); ?>admin/nlp-function/entity/insert" method="POST">
                  <div class="form-group">
                    <h5>Entity Name</h5>
                    <input required type="text" class="form-control" name="entity_name">
                  </div>
