...
class Database extends CI_Controller
{
  ...
  {
    $this->check_session();
    $sql = "select id_submit_db_connection,db_name,db_hostname,db_username,db_password,status_aktif_db_connection,tgl_db_connection_last_modified from tbl_db_connection where status_aktif_db_connection < 2";
    $result = executeQuery($sql);
    $data["database"] = $result->result_array();
    $this->load->view("admin/km/database/v_database", $data);
  }
  public function recycle_bin()
  {
    ...
    $data["database"] = $result->result_array();
    $this->load->view("admin/km/database/v_database_recycle_bin", $data);
  }
  ...
  private function check_session()
  {
    if ($this->session->id_user == "") {
      ...
      redirect("admin/km-function/welcome");
    }
  }
}
