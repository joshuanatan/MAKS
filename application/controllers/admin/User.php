...
class User extends CI_Controller
{
  ...
  {
    $this->check_session();
    $sql = "select id_submit_user,nama_user,email_user,status_aktif_user,tgl_user_last_modified from tbl_user where status_aktif_user < 2";
  ...
  {
    $this->check_session();
    $sql = "select id_submit_user,nama_user,email_user,status_aktif_user,tgl_user_last_modified from tbl_user where id_submit_user != ? and status_aktif_user = 2";
    $args = array(
