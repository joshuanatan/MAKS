...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2021 at 04:32 PM
...
(1, 'Total Nominal Penjualan Tahun Ini', 'Select sum(trxamt) as jumlah_penjualan from tbl_sales where year(trxdate)= year(now());', '-', 'get_nominal_transaksi_tahun_ini', '4', 1, '2', '2021-10-02 15:23:36', 0),
...
(20, 'Dataset Tutorial 1', 'select namaKota, namaToko, namaProduk, jumlahPenjualan from tbl_tertentu where nama_kota=&kota1 or nama_kota = &kota2 wehre where where', '-', 'get_jumlah_toko', '1', 1, '1', '2021-10-13 20:53:26', 0);
...
(91, 20, 'namaKota', 'Nama Kota', 'tbl_tertentu'),
(92, 20, 'namaToko', 'Toko', 'tbl_tertentu');
...
(22, 3, 4, '0', '2021-10-02 15:26:00', 0),
...
(32, 3, 6, '0', '2021-10-02 15:26:00', 0),
...
(76, 20, 3, '1', '2021-10-13 20:54:00', NULL),
(77, 20, 4, '1', '2021-10-13 20:54:00', NULL),
(78, 20, 8, '1', '2021-10-13 20:54:00', NULL);
...
(1, '127.0.0.1', 'root', 'f143b982a016a625734ab726e6e4370e763cc06f4cf8c549d82ee122a632b0cc4b3f19110f5d4fd8a0329f92215f48f45c88b194589f37ec7fed4f1326522bb2kxljUIjOaxRGftOYwrZViQa6Fill1hSodiM/wxVYr4U=', 'maks_dataset', '1', '2021-09-10 21:35:22', 0),
(2, '127.0.0.1', 'DBSUSER001', 'e9e67c088885b6299f59ec79ba24200c007d80572473ca86ac94d73b8580820f5d31b9fa21f52e16fa1f3e58855816d6d2f1e3e1ca05d92949312a1ecc4eac38x8cNLtUnEpuTWLeeGnUbyPQaYx8f8MSa1dhLKXKsK30=', 'db_name', '2', '2021-09-20 21:37:29', 0),
(3, '127.0.0.1', 'DBSUSER0011', '80eadb6512a314a771b14fd592e2a58000544c6842999d3eacb0b7d5418dbd614a36b75770981663713b82052f74be5e60789dbc941d722a36b06edd5f3c6460pns1U44rFpq24GslS1xIKI7NKyW/DWEwqrw1+ShW5B0=', 'db_name', '2', '2021-09-20 21:45:00', 0),
(4, '127.0.0.1', 'root', '854457c2f98e6e0ce92cad517cfe99d3b88d70d80ec71185bd96255bdb02c95c639f115c57ef12d1a7487edd5a2bfd515f030098bbf00c91fcf06dd5298097e02JFXX1oyqRMmHPBI39sfT4A3ts1+eQTpHByPGVW5MZQ=', 'databasename', '2', '2021-10-13 21:28:07', 0),
(5, '192.168.1.1', 'test', '561ac33c56624f71ab2c95f4a14321ddc894da15bdbc1ff400910bdfd828ffab9a396885c414e984506e33945ed1e2f358cd7f3607ef22c4c78917add44d3a8a+71idSR2lnQFRclNFG5QvwRhMA8/5Fr1VKC+zZf1f/A=', 'test', '1', '2021-10-13 21:29:37', 0);
...
(2, 'John Doe Joseph', '81dc9bdb52d04dc20036dbd8313ed055', 'johndoe@emailx.com', '1', '2021-09-19 12:20:21', 1),
(0, 'test test update', '202cb962ac59075b964b07152d234b70', 'testupdate@email.com', '1', '2021-09-19 12:28:35', 0),
(0, 'test test update', '202cb962ac59075b964b07152d234b70', 'testupdate@email.com', '1', '2021-09-19 12:28:35', 0);
...
(1, 'copameb883@rebation.com / maksmds20271', 'Joshua Natan', '2964504537100638', 'maks', 'AJOGKHTTMRI3HRYKM4CJCQTXM335EWEW', '1', '2021-10-13 21:21:02', 0);
...
--
ALTER TABLE `tbl_dataset`
  MODIFY `id_submit_dataset` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tbl_dataset_dbfield_mapping`
--
ALTER TABLE `tbl_dataset_dbfield_mapping`
  MODIFY `id_pk_dataset_dbfield_mapping` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT for table `tbl_dataset_entity`
--
ALTER TABLE `tbl_dataset_entity`
  MODIFY `id_pk_dataset_entity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT for table `tbl_dataset_related`
--
ALTER TABLE `tbl_dataset_related`
  MODIFY `id_submit_dataset_related` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `tbl_db_connection`
--
ALTER TABLE `tbl_db_connection`
  MODIFY `id_submit_db_connection` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
